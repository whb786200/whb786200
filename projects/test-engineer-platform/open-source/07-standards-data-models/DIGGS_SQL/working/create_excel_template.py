...
def main():
    ...
    try:
        ...
        blank_template = os.path.join(script_dir, "Geotechnical_Template_Blank.xlsx")
        sample_template = os.path.join(script_dir, "Geotechnical_Template_Sample.xlsx")
        documentation = os.path.join(script_dir, "Template_Documentation.xlsx")
